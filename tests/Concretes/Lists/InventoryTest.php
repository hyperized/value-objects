...
class InventoryTest extends TestCase {
	public function testFromCommaSeperatedString(): void {
		self::assertSame( [ 'one', 'two' ], Inventory::fromCommaSeperatedString( 'one,two' )->getValue() );
	}
	...
	public function testStringContains(): void {
		self::assertTrue( Inventory::fromCommaSeperatedString( 'one,two' )->contains( 'one' ) );
	}

	public function testStringDoesntContain(): void {
		self::assertFalse( Inventory::fromCommaSeperatedString( 'one,two' )->contains( 'hello' )
		);
	}
